...
HEADERS += src/activemasternode.h \
           ...
           src/crypto/luffa.h \
           src/crypto/cubehash.h \
           src/crypto/shavite.h \
           src/crypto/simd.h \
           src/crypto/echo.h \
...
RESOURCES += src/qt/ballcoin.qrc src/qt/ballcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ballcoin_bg.ts \
                src/qt/locale/ballcoin_de.ts \
                src/qt/locale/ballcoin_en.ts \
                src/qt/locale/ballcoin_es.ts \
                src/qt/locale/ballcoin_fi.ts \
                src/qt/locale/ballcoin_fr.ts \
                src/qt/locale/ballcoin_it.ts \
                src/qt/locale/ballcoin_ja.ts \
                src/qt/locale/ballcoin_pl.ts \
                src/qt/locale/ballcoin_pt.ts \
                src/qt/locale/ballcoin_ru.ts \
                src/qt/locale/ballcoin_sk.ts \
                src/qt/locale/ballcoin_sv.ts \
                src/qt/locale/ballcoin_vi.ts \
                src/qt/locale/ballcoin_zh_CN.ts \
                src/qt/locale/ballcoin_zh_TW.ts
