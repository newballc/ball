...
#define QAPP_ORG_NAME "BALLcoin"
#define QAPP_ORG_DOMAIN "ball-coin.com"
#define QAPP_APP_NAME_DEFAULT "BALLcoin-Qt"
#define QAPP_APP_NAME_TESTNET "BALLcoin-Qt-testnet"
